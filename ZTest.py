...
second_std_deviation_start, second_std_deviation_end = mean-std_deviation, mean+(2*std_deviation)
third_std_deviation_start, third_std_deviation_end = mean-std_deviation, mean+(3*std_deviation)
